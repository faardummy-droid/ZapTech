...
export const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      {/* 1. Full-Bleed EV Car Background Image with Slow Breathing Zoom */}
      <motion.div
      ...
      >
        <Image
          ...
          fill
          priority
          className="object-cover object-center opacity-40 mix-blend-luminosity brightness-90"
        />
      </motion.div>

      {/* 2. Sophisticated Multi-Layered Dark Gradient & Glass Overlay */}
      <div className="absolute inset-0 z-[1] bg-gradient-to-b from-[#02182B]/90 via-[#043E69]/75 to-[#02182B]/95 pointer-events-none" />
      <div className="absolute inset-0 z-[1] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-transparent via-[#02182B]/40 to-[#02182B] pointer-events-none" />

      {/* 3. Ambient Glowing Energy Orbs in Background */}
      <motion.div
        animate={{
          scale: [1, 1.25, 1],
          opacity: [0.3, 0.5, 0.3],
      ...
      {/* 4. Animated Energy Vectors & Light Curves SVG Overlay */}
      <svg
        className="absolute inset-0 w-full h-full pointer-events-none z-[2] opacity-45"
      ...
      {/* 5. Centered Hero Content Container */}
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full text-center flex flex-col items-center justify-center my-auto">
        ...
        {/* Dynamic Auto-Looping Centered Headline with Fixed Height Container (Eliminates Jitter) */}
        <div className="h-[140px] sm:h-[170px] md:h-[180px] flex items-center justify-center overflow-visible w-full relative">
        ...
        {/* High-Contrast Crisp Centered Value Proposition Subtitle (Position is completely stable) */}
        <motion.p
        ...
        >
          ZapTech builds intelligent clean-energy infrastructure for a more connected and sustainable mobility ecosystem across Indonesia.
        </motion.p>

        {/* Centered Modern Action Buttons */}
        <motion.div
          initial={{ opacity: 0, y: 15 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Link
            ...
            className="group relative inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-[#076FB8] to-[#043E69] text-white font-bold hover:from-[#0983d6] hover:to-[#06538b] transition-all shadow-[0_0_25px_rgba(7,111,184,0.45)] hover:shadow-[0_0_35px_rgba(7,111,184,0.7)] hover:scale-105 active:scale-95 text-sm sm:text-base border border-white/20"
          >
          ...
          <a
            href="#about"
            className="inline-flex items-center gap-2.5 px-7 py-4 rounded-2xl bg-white/10 backdrop-blur-md text-white font-semibold border border-white/25 hover:bg-white/20 hover:border-white/40 transition-all shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 text-sm sm:text-base"
          >
